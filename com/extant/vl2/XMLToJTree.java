 ...
 * @author jms
 * 
 * This class (1) constructs a Document from CHART.XML,
 *            (2) builds a JTree representation of the chart, and
 *            (3) returns the JTree.
 *
 */
...
//    public JTree XMLToJTree( XProperties props, String chartXMLFilename, LogFile logger )
...
//    }
    ...
    public JTree buildTree( ChartElement elementList[] )
        throws VLException
    {
        //logger.setLogLevel(LogFile.DEBUG_LOG_LEVEL);
...
//        // We alter this behavior to require a triple-click on button 1 to do that, so we can use
//        // the double-click for our messages (see mouseClicked() below)
//        tree.setToggleClickCount(3);
        return jTree;
    }

    private int build( ChartElement elementList[], int startIndex, ChartTreeNode parent, int level )
    throws VLException
    {
...
//            }
        ...
        extends DefaultMutableTreeNode
    {
        ...
        {
            try { return formatNode( element, nodeDescrSpec ); }
            catch (VLException vlx) {  return "<ERROR>"; }
        }
