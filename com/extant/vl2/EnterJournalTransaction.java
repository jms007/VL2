    ...
    extends javax.swing.JPanel
{
     ...
     */
    public EnterJournalTransaction(Chart chart, XProperties props, LogFile logger)
    {
        initComponents();
        // For testing:
        ...
        lblEntityName.setText(props.getString("EntityLongName"));
    ...
    private void comboCreditAccountKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_comboCreditAccountKeyTyped
        creditAccountFinder.processKeyEvent( evt );
    }//GEN-LAST:event_comboCreditAccountKeyTyped

    private void comboDebitAccountKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_comboDebitAccountKeyTyped
    ...
    private void EnterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EnterActionPerformed
        ...
        if (txtDate.getText().isEmpty()) return;
        ...
        {
            if (comboDebitAccount.getSelectedIndex() < 0) return;
            ...
            GLEntry glEntryDebit = new GLEntry
                ( jRef
                , GSNMan.getGSN()
                , "E"
                , "D"
        ...
        {
            if (comboCreditAccount.getSelectedIndex() < 0) return;
            creditAmount = txtCreditAmount.getText();
            ...
            GLEntry glEntryCredit = new GLEntry
                ( jRef
                , GSNMan.getGSN()
                , "E"
                , "C"
    ...
    private void PostActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_PostActionPerformed
        ...
        try
        {
            UsefulFile GLFile = new UsefulFile(props.getString("GLFile"), "w+");
    ...
    public void manageStatusBar()
    {
        ...
        else statusMsg = Strings.plurals( "unnposted entry", unpostedEntries.size());
    ...
    private void CloseActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CloseActionPerformed
        if (!unpostedEntries.isEmpty())
        {
            ...
            ( jFrame, "Unposted Entries", "There are unposted entries!\nDo you want to discard them?"
                , MsgBox.YES_NO
            );
