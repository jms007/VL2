...
{
    public Search(XProperties props)
    {
        initComponents();
    ...
    private void grep( String needle )
    throws IOException
    {
        String image;
...
//        needle = needle.replace( '?', ' ' );
        ...
        while ( !file.EOF() )
        {
            ...
            if ( image.contains(needle) ) addEntry( image );
        }
        file.close();
    }
