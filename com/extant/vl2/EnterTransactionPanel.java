 ...
 * @author jms
 */
public class EnterTransactionPanel
    extends javax.swing.JPanel
{
    ...
    private void EnterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EnterActionPerformed
        ...
        if (transType.startsWith("R")) drcr = "C";
        else drcr = "D";
    ...
    private void PostActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_PostActionPerformed
        ...
        //String GLFilename = props.getString("WorkDir") + props.getString("GLFile");
        logger.logDebug("GLFilename=" + GLFilename);
//        try { GL0010 = new UsefulFile(GLFilename, "rw"); }
//        catch (IOException iox)
//        {   logger.logFatal("Unable to open " + GLFilename + ": " + iox.getMessage()); }
//
        try
        {     /***** See VL2\Test Data\Notes.txt *****/
            ...
            else balEntry.setField("DESCR", "Cash Disbursement");
        ...
        {   // Undo everything, inform user, and get out leaving GSN unchanged
            logger.logFatal("Failed to move unposted transaction to GL0010 (" + vlx.getMessage() + ")");
            return;  // Get out
        }
    }//GEN-LAST:event_PostActionPerformed

    private void comboAccountKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_comboAccountKeyTyped
    ...
    private void btnViewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewActionPerformed
        ...
        catch (IOException iox) { logger.log ("File Error: " + iox.getMessage() ); }
        catch (UtilitiesException ux) { logger.log ("Util Error: " + ux.getMessage()); }
    ...
    private void comboAccountFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_comboAccountFocusLost
        manageButtons();
    ...
    public EnterTransactionPanel(Chart chart, LogFile logger, String transType, XProperties props)
        throws IOException
    {
        initComponents();
        this.logger = logger;
        ...
        this.props = props;
        String entityLongName = props.getString("VL.EntityLongName");
        //this.setTitle(entityLongName);
        lblCoName.setText(entityLongName);
        cashAcctNo = props.getString("VL.CashAcctNo");
        ...
        logger.setLogLevel(LogFile.DEBUG_LOG_LEVEL);
        logger.logDebug("EntityLongName="+props.getString("EntityLongName"));
        logger.logDebug("CashAcctNo="+props.getString("CashAcctNo"));
        ...
        imbalanceAmount = 0L;
        clearForm();
        String GLFilename = props.getString("WorkDir") + props.getString("VL.GLFile");
        logger.logDebug("GLFilename="+GLFilename);
...
//        if (!OKdescr) System.out.print("OKdescr");
        ...
        boolean OKtoEnter = new Julian(txtDate.getText()).isValid()
            && comboAccount.getSelectedIndex() >= 0
            && Strings.regexMatch("\\d+\\.\\d\\d", txtAmount.getText())
            && !txtDescr.getText().isEmpty();
        //System.out.print("are showing false.  OKtoEnter=");
        //if (OKtoEnter) System.out.println("OKtoEnter=true");
        //else System.out.println("OKtoEnter=false");
    ...
    public void manageStatusBar()
    {
        ...
        else statusMsg = Strings.plurals( "unposted entry", unpostedEntries.size());
