...
public class VLException extends java.lang.Exception
{
  ...
  public static String Messages[] =
    ...
    , "DRCR Field is not valid: "
    , "Amount Field is not valid: "
    , "Account Number contains imbedded space: "
    , "Transaction Date is not valid: "
    , "One or more entries contain errors"
    , "Internal Error: "
    , "Error(s) in Chart File "
    , "File Not Found: "
    , "No Retained Earnings Account Found"
    , "Account not in Chart: "
    , "Chart contains duplicate Accounts"
    , "Incorrect Version of Chart: "
    , "Unrecognized source for EFT file: "
    , "Syntax error in CSV file: "
    , "IO Error while processing file "
    , "Basic/Persistent Data Services Unavailable"
    , "Invalid Record Length "
    , "Inconsistent Dates: "
    , "Table Contains Data: "
    , ".ini file not found in "
    , "More than one .ini file in "
    , "Chart does not contain CashAcct: "
    , "VLInit Abnormal Exit "
    , "invalid set: "
    , "Trace "
    , "BadElementException "
    , "DocumentException "
    ...
    , "Unable to initialize XML Chart"
    , "Operation incompatible with element "
    , "Unable to create directory "
    , "Directory is not empty "
    , "Database contains tables for year "
